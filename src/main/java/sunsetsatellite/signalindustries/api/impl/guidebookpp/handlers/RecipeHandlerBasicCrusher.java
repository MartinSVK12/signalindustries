...
import sunsetsatellite.signalindustries.api.impl.guidebookpp.recipes.RecipeBasicCrusher;
...
public class RecipeHandlerBasicCrusher
    ...
    public ContainerGuidebookRecipeBase getContainer(Object o) {
        RecipeBasicCrusher recipe = (RecipeBasicCrusher) o;
        return new ContainerGuidebookCrusherRecipe(new ItemStack(SignalIndustries.basicCrusher),recipe.itemInputs,recipe.fluidInputs,recipe.itemOutputs,recipe.fluidOutputs);
    }
    ...
    public ArrayList<?> getRecipes() {
        HashMap<Integer, ItemStack> rawRecipes = new HashMap<>(BasicCrusherRecipes.instance.getRecipeList());
        ArrayList<RecipeBasicCrusher> recipes = new ArrayList<>();
        rawRecipes.forEach((I,O)->{
            ...
            recipes.add(new RecipeBasicCrusher(singletonList,null,singletonlist2, null));
        });
        return recipes;
    }
    ...
    public String getNameOfRecipeOutput(Object recipe){
        ...
        return trans.translateKey(((RecipeBasicCrusher)recipe).itemOutputs.get(0).getItemName()+".name").toLowerCase();
    }

    @Override
    public String getHandlerName() {
        return "basic signalum crusher";
    }
}
