...
public class AwakenedQuestChapter extends QuestChapterPage {
    ...
    public @NotNull String getName() {
        return I18n.getInstance().translateNameKey("chapter.signalindustries.awakened");
    }

    @Override
    public @NotNull String getDescription() {
        return I18n.getInstance().translateDescKey("chapter.signalindustries.awakened");
    }

    @Override
    public @Nullable IconCoordinate getBackgroundTile(ScreenQuestbook screen, int layer, Random random, int tileX, int tileY) {
        return TextureRegistry.getTexture(SIBlocks.blockTextures.get(SIBlocks.awakenedSignalumCrystalBlock).defaultTextures.get(Side.NORTH));
    }
