...
public class PrototypeQuestChapter extends QuestChapterPage {
    ...
    public PrototypeQuestChapter() {
        super("signalindustries:prototype");
    }

    @Override
    public @NotNull String getName() {
        return I18n.getInstance().translateNameKey("chapter.signalindustries.prototype");
    }

    @Override
    public @NotNull String getDescription() {
        return I18n.getInstance().translateDescKey("chapter.signalindustries.prototype");
    }
