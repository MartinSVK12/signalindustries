...
public class SignalIndustries implements ModInitializer {
    ...
    public static final Block prototypeMachineCore = BlockHelper.createBlock(MOD_ID,new BlockTiered(config.getFromConfig("prototypeMachineCore",availableBlockId++), Tier.PROTOTYPE,Material.rock),"prototype.machine","machineprototype.png",Block.soundStoneFootstep,2.0f,3.0f,0);
    public static final Block basicMachineCore = BlockHelper.createBlock(MOD_ID,new BlockTiered(config.getFromConfig("basicMachineCore",availableBlockId++), Tier.BASIC,Material.rock),"basic.machine","machinebasic.png",Block.soundStoneFootstep,3.0f,8.0f,1.0f/2.0f);
    public static final Block reinforcedMachineCore = BlockHelper.createBlock(MOD_ID,new BlockTiered(config.getFromConfig("reinforcedMachineCore",availableBlockId++), Tier.REINFORCED,Material.rock),"reinforced.machine","machinereinforced.png",Block.soundStoneFootstep,4.0f,15.0f,1.0f/1.50f);
    public static final Block awakenedMachineCore = BlockHelper.createBlock(MOD_ID,new BlockTiered(config.getFromConfig("awakenedMachineCore",availableBlockId++), Tier.AWAKENED,Material.rock),"awakened.machine","machineawakened.png",Block.soundStoneFootstep,5.0f,50.0f,1);

    public static final Block prototypeConduit = BlockHelper.createBlock(MOD_ID,new BlockConduit(config.getFromConfig("prototypeConduit",availableBlockId++), Tier.PROTOTYPE,Material.glass),"prototype.conduit","conduitprototype.png",Block.soundGlassFootstep,1.0f,1.0f,0);
    public static final Block basicConduit = BlockHelper.createBlock(MOD_ID,new BlockConduit(config.getFromConfig("basicConduit",availableBlockId++), Tier.BASIC,Material.glass),"basic.conduit","conduitbasic.png",Block.soundGlassFootstep,1.0f,1.0f,0);
    public static final Block reinforcedConduit = BlockHelper.createBlock(MOD_ID,new BlockConduit(config.getFromConfig("reinforcedConduit",availableBlockId++), Tier.REINFORCED,Material.glass),"reinforced.conduit","conduitreinforced.png",Block.soundGlassFootstep,1.0f,1.0f,0);
    public static final Block awakenedConduit = BlockHelper.createBlock(MOD_ID,new BlockConduit(config.getFromConfig("awakenedConduit",availableBlockId++), Tier.AWAKENED,Material.glass),"awakened.conduit","conduitawakened.png",Block.soundGlassFootstep,1.0f,1.0f,0);

    public static final Block prototypeFluidConduit = BlockHelper.createBlock(MOD_ID,new BlockFluidConduit(config.getFromConfig("prototypeFluidConduit",availableBlockId++), Tier.PROTOTYPE,Material.glass),"prototype.conduit.fluid","fluidpipeprototype.png",Block.soundGlassFootstep,1.0f,1.0f,0);
    public static final Block basicFluidConduit = BlockHelper.createBlock(MOD_ID,new BlockFluidConduit(config.getFromConfig("basicFluidConduit",availableBlockId++), Tier.BASIC,Material.glass),"basic.conduit.fluid","fluidpipebasic.png",Block.soundGlassFootstep,1.0f,1.0f,0);
    public static final Block reinforcedFluidConduit = BlockHelper.createBlock(MOD_ID,new BlockFluidConduit(config.getFromConfig("reinforcedFluidConduit",availableBlockId++), Tier.REINFORCED,Material.glass),"reinforced.conduit.fluid","fluidpipereinforced.png",Block.soundGlassFootstep,1.0f,1.0f,0);

    public static final Block infiniteEnergyCell = BlockHelper.createBlock(MOD_ID,new BlockEnergyCell(config.getFromConfig("infiniteEnergyCell",availableBlockId++), Tier.INFINITE,Material.glass),"infinite.energyCell","cellprototype.png",Block.soundGlassFootstep,-1.0f,1000000.0f,0);
    public static final Block prototypeEnergyCell = BlockHelper.createBlock(MOD_ID,new BlockEnergyCell(config.getFromConfig("prototypeEnergyCell",availableBlockId++), Tier.PROTOTYPE,Material.glass),"prototype.energyCell","cellprototype.png",Block.soundGlassFootstep,2.0f,5.0f,0);
    public static final Block basicEnergyCell = BlockHelper.createBlock(MOD_ID,new BlockEnergyCell(config.getFromConfig("basicEnergyCell",availableBlockId++), Tier.BASIC,Material.glass),"basic.energyCell","cellbasic.png",Block.soundGlassFootstep,2.0f,5.0f,0);

    public static final Block prototypeFluidTank = BlockHelper.createBlock(MOD_ID,new BlockSIFluidTank(config.getFromConfig("prototypeFluidTank",availableBlockId++), Tier.PROTOTYPE,Material.glass),"prototype.fluidTank","fluidtankprototype.png",Block.soundGlassFootstep,2.0f,5.0f,0);
    ...
    public static final Block prototypeExtractor = BlockHelper.createBlock(MOD_ID,new BlockExtractor(config.getFromConfig("prototypeExtractor",availableBlockId++), Tier.PROTOTYPE,Material.rock),"prototype.extractor","prototypeblank.png","extractorprototypesideempty.png",Block.soundStoneFootstep,2,3,0);
    public static final Block basicExtractor = BlockHelper.createBlock(MOD_ID,new BlockExtractor(config.getFromConfig("basicExtractor",availableBlockId++), Tier.BASIC,Material.rock),"basic.extractor","basicblank.png","extractorbasicsideempty.png",Block.soundStoneFootstep,2,3,0);
    ...
    public static final Block prototypeCrusher = BlockHelper.createBlock(MOD_ID,new BlockCrusher(config.getFromConfig("prototypeCrusher",availableBlockId++), Tier.PROTOTYPE,Material.rock),"prototype.crusher","crusherprototypetopinactive.png","prototypeblank.png","crusherprototypeside.png","prototypeblank.png","prototypeblank.png","prototypeblank.png",Block.soundStoneFootstep,2,3,0);
    public static final Block basicCrusher = BlockHelper.createBlock(MOD_ID,new BlockCrusher(config.getFromConfig("basicCrusher",availableBlockId++), Tier.BASIC,Material.iron),"basic.crusher","crusherbasictopinactive.png","basicblank.png","crusherbasicside.png","basicblank.png","basicblank.png","basicblank.png",Block.soundMetalFootstep,2,3,0);
    ...
    public static final Block prototypeAlloySmelter = BlockHelper.createBlock(MOD_ID,new BlockAlloySmelter(config.getFromConfig("prototypeAlloySmelter",availableBlockId++), Tier.PROTOTYPE,Material.rock),"prototype.alloySmelter","prototypeblank.png","prototypeblank.png","alloysmelterprototypeinactive.png","prototypeblank.png","prototypeblank.png","prototypeblank.png",Block.soundStoneFootstep,2,3,0);
    public static final Block basicAlloySmelter = BlockHelper.createBlock(MOD_ID,new BlockAlloySmelter(config.getFromConfig("basicAlloySmelter",availableBlockId++), Tier.BASIC,Material.iron),"basic.alloySmelter","basicblank.png","basicblank.png","alloysmelterbasicinactive.png","basicblank.png","basicblank.png","basicblank.png",Block.soundStoneFootstep,2,3,0);
    ...
    public static final Block prototypePlateFormer = BlockHelper.createBlock(MOD_ID,new BlockPlateFormer(config.getFromConfig("prototypePlateFormer",availableBlockId++), Tier.PROTOTYPE,Material.rock),"prototype.plateFormer","prototypeblank.png","prototypeblank.png","plateformerprototypeinactive.png","prototypeblank.png","prototypeblank.png","prototypeblank.png",Block.soundStoneFootstep,2,3,0);
    ...
    public static final Block prototypeCrystalCutter = BlockHelper.createBlock(MOD_ID,new BlockCrystalCutter(config.getFromConfig("prototypeCrystalCutter",availableBlockId++), Tier.PROTOTYPE,Material.rock),"prototype.crystalCutter","prototypeblank.png","prototypeblank.png","crystalcutterprototypeinactive.png","prototypeblank.png","prototypeblank.png","prototypeblank.png",Block.soundStoneFootstep,2,3,0);
    ...
    public static final Block basicCrystalChamber = BlockHelper.createBlock(MOD_ID,new BlockCrystalChamber(config.getFromConfig("basicCrystalChamber",availableBlockId++), Tier.BASIC,Material.rock),"basic.crystalChamber","basicblank.png","basicblank.png","basiccrystalchambersideinactive.png","basicblank.png","basicblank.png","basicblank.png",Block.soundStoneFootstep,2,3,0);
    ...
    public static final Block basicInfuser = BlockHelper.createBlock(MOD_ID,new BlockInfuser(config.getFromConfig("basicInfuser",availableBlockId++), Tier.BASIC,Material.iron),"basic.infuser","basicblank.png","infuserbasicsideinactive.png",Block.soundMetalFootstep,2,3,0);
    ...
    public static final Block basicWrathBeacon = BlockHelper.createBlock(MOD_ID,new BlockWrathBeacon(config.getFromConfig("basicWrathBeacon",availableBlockId++), Tier.BASIC,Material.iron),"basic.wrathBeacon","basicblank.png","wrathbeacon.png",Block.soundMetalFootstep,10f,500f,1);
    ...
    public static final Block dilithiumStabilizer = BlockHelper.createBlock(MOD_ID,new BlockDilithiumStabilizer(config.getFromConfig("dilithiumStabilizer",availableBlockId++), Tier.REINFORCED,Material.iron),"reinforced.dilithiumStabilizer","reinforcedblank.png","reinforcedblank.png","dilithiumtopinactive.png","dilithiumstabilizersideinactive.png","dilithiumstabilizersideinactive.png","dilithiumstabilizersideinactive.png",Block.soundMetalFootstep,5f,20f,1);
    ...
    public static final Block dilithiumBooster = BlockHelper.createBlock(MOD_ID,new BlockDilithiumBooster(config.getFromConfig("dilithiumBooster",availableBlockId++), Tier.REINFORCED,Material.iron),"reinforced.dilithiumBooster","reinforcedblank.png","reinforcedblank.png","dilithiumtopinactive.png","dilithiumboostersideinactive.png","dilithiumboostersideinactive.png","dilithiumboostersideinactive.png",Block.soundMetalFootstep,5f,20f,1);
    ...
    public static final Item signalumSaber = ItemHelper.createItem(MOD_ID, new ItemSignalumSaber(config.getFromConfig("signalumSaber",availableItemId++), Tier.REINFORCED, ToolMaterial.stone), "signalumSaber", "signalumsaberunpowered.png");
