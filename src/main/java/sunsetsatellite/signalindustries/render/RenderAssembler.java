...
public class RenderAssembler extends TileEntityRenderer<TileEntityAssembler> {
	...
	@Override
	public void doRender(TessellatorGeneral tessellator, TileEntityAssembler tileEntity, double x, double y, double z, float partialTick) {
