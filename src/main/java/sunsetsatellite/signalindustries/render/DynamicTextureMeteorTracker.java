...
public class DynamicTextureMeteorTracker extends DynamicTexture {
    ...
    public void postInit() {
        ...
        BufferedImage atlas = targetTexture.parentAtlas.colorImage;
    ...
    @Override
    public void update() {
		byte[] imageData = getImageData(this.layerColor);
        ...
        for (int i = (int) (-4 * scaleFactor); i <= (int) (4 * scaleFactor); ++i) {
            ...
            imageData[j * 4] = (byte) r;
            imageData[j * 4 + 1] = (byte) g;
            imageData[j * 4 + 2] = (byte) b;
            imageData[j * 4 + 3] = (byte) a;
        }
