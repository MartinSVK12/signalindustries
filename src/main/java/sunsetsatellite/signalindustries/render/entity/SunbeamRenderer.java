...
{
    public void renderSunbeam(ProjectileSunbeam arrow, double x, double y, double z,
                              float yaw, float partialTick)
    {
        ...
        bindTexture("/assets/signalindustries/entity/sunbeam.png");
        GL11.glPushMatrix();
    ...
    @Override
    public void render(Tessellator tessellator, ProjectileSunbeam entity, double d, double e, double f, float g, float h) {
