...
public class MenuPowerSuit extends MenuFluid {
    ...
    public MenuPowerSuit(ContainerInventory playerInv, int slotIndex, boolean isArmor) {
        super(new InventoryPowerSuit(playerInv.armorItemInSlot(HumanArmorShape.values()[slotIndex])));

        this.player = playerInv.player;
        this.slotIndex = slotIndex;

        ItemArmorTiered armor = (ItemArmorTiered) playerInv.armorItemInSlot(HumanArmorShape.values()[slotIndex]).getItem();
    ...
    @Override
    public void onCraftGuiClosed(@NonNull Player player) {
