...
public class MenuCrystalCutter extends MenuMachine {
    public MenuCrystalCutter(ContainerInventory inv, TileEntityFluidItemContainer tile) {
        super(inv, tile);
        ...
        this.addFluidSlot(new SlotFluid(tile, 1, 28, 17));
