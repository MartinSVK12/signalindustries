...
public class MenuPump extends MenuMachine {
    public MenuPump(ContainerInventory inv, TileEntityFluidItemContainer tile) {
        super(inv, tile);

        addFluidSlot(new SlotFluid(tile, 0, 80, 53));
        addFluidSlot(new SlotFluid(tile, 1, 80, 17));
