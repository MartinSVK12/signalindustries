...
public class MenuExtractor extends MenuMachine {
    public MenuExtractor(ContainerInventory inv, TileEntityFluidItemContainer tile) {
        super(inv, tile);

        SlotFluid slot = new SlotFluid(tile, 0, 116,35);
        addFluidSlot(slot);
