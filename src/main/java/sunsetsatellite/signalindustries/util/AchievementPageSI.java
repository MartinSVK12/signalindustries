...
public class AchievementPageSI extends AchievementPage {
    ...
    public @NotNull String getName() {
        return I18n.getInstance().translateNameKey("gui.achievements.page.signalindustries");
    }

    @Override
    public @NotNull String getDescription() {
        return I18n.getInstance().translateDescKey("gui.achievements.page.signalindustries");
    }
