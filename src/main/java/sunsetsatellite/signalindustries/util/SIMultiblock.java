...
public class SIMultiblock extends Multiblock {
    ...
    public SIMultiblock(String modId, String translateKey, CompoundTag data, boolean includeAir, Tier tier) {
        super(modId, translateKey, data, includeAir);
    ...
    public SIMultiblock(String modId, String translateKey, String filePath, boolean includeAir, Tier tier) {
        super(modId, translateKey, filePath, includeAir);
        SignalIndustries.LOGGER.info(String.format("Multiblock '%s' contains %d blocks.", translateKey, this.data.getCompound("Blocks").getValues().size()));
        this.tier = tier;
