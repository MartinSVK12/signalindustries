...
public class SIAchievements extends DataInitializer {
	...
	public void initClient(){
		AchievementPage SIGNAL_INDUSTRIES = new AchievementPageSI();
		...
		SIGNAL_INDUSTRIES.addAchievement(ROM_CHIP, -2, 8);
		...
		SIGNAL_INDUSTRIES.addAchievement(STARFALL, -2, 6);
		...
		SIGNAL_INDUSTRIES.addAchievement(GATE, 10, 22);
