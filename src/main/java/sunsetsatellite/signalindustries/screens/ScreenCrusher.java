...
public class ScreenCrusher extends ScreenFluid {

    public Player player;
    public TileEntityCrusher tile;

    public ScreenCrusher(ContainerInventory inv, TileEntity tile) {
        super(new MenuCrusher(inv, (TileEntityFluidItemContainer) tile));
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        switch (tile.tier){
            case PROTOTYPE:
                ...
                break;
            case BASIC:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/generic_basic_machine.png");
                break;
            case REINFORCED:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/generic_reinforced_machine.png");
                break;
            case AWAKENED:
                break;
        }
