...
public class ScreenFluidIOConfig extends Screen {
    ...
    public ScreenFluidIOConfig(Player player, MenuAbstract menu, Screen parent, TileEntityFluidItemContainer tile) {
        super(parent);
    ...
    @Override
    public void init() {
        buttons.add(new ButtonElement(2, Math.round(width / 2f) - 10, Math.round(height / 2f) - 63, 15, 15, tile.fluidConnections.get(Direction.Y_POS).getLetter())); //Y+
        buttons.add(new ButtonElement(4, Math.round(width / 2f) - 10, Math.round(height / 2f) - 48, 15, 15, tile.fluidConnections.get(Direction.Z_POS).getLetter())); //Z+
        buttons.add(new ButtonElement(3, Math.round(width / 2f) - 10, Math.round(height / 2f) - 33, 15, 15, tile.fluidConnections.get(Direction.Y_NEG).getLetter())); //Y-
        buttons.add(new ButtonElement(0, Math.round(width / 2f) + 4, Math.round(height / 2f) - 48, 15, 15, tile.fluidConnections.get(Direction.X_POS).getLetter())); //X+
        buttons.add(new ButtonElement(1, Math.round(width / 2f) - 24, Math.round(height / 2f) - 48, 15, 15, tile.fluidConnections.get(Direction.X_NEG).getLetter())); //X-
        buttons.add(new ButtonElement(5, Math.round(width / 2f) + 4, Math.round(height / 2f) - 33, 15, 15, tile.fluidConnections.get(Direction.Z_NEG).getLetter())); //Z-

        buttons.add(new ButtonElement(8, Math.round(width / 2f) - 10 + 50, Math.round(height / 2f) - 63, 15, 15, tile.activeFluidSlots.get(Direction.Y_POS) == -1 ? "*" : String.valueOf(tile.activeFluidSlots.get(Direction.Y_POS))));
        buttons.add(new ButtonElement(10, Math.round(width / 2f) - 10 + 50, Math.round(height / 2f) - 48, 15, 15, tile.activeFluidSlots.get(Direction.Z_POS) == -1 ? "*" : String.valueOf(tile.activeFluidSlots.get(Direction.Z_POS))));
        buttons.add(new ButtonElement(9, Math.round(width / 2f) - 10 + 50, Math.round(height / 2f) - 33, 15, 15, tile.activeFluidSlots.get(Direction.Y_NEG) == -1 ? "*" : String.valueOf(tile.activeFluidSlots.get(Direction.Y_NEG))));
        buttons.add(new ButtonElement(6, Math.round(width / 2f) + 4 + 50, Math.round(height / 2f) - 48, 15, 15, tile.activeFluidSlots.get(Direction.X_POS) == -1 ? "*" : String.valueOf(tile.activeFluidSlots.get(Direction.X_POS))));
