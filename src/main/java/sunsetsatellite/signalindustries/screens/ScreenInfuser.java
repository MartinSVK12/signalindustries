...
public class ScreenInfuser extends ScreenMachineSimple {
    ...
    public ScreenInfuser(ContainerInventory inv, TileEntity tile) {
        super(new MenuInfuser(inv, (TileEntityFluidItemContainer) tile));
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/infuser_basic.png");
        switch (tile.tier){
            case BASIC:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/infuser_basic.png");
                break;
            case REINFORCED:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/infuser_reinforced.png");
                break;
        }
