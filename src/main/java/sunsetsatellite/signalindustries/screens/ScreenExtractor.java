...
public class ScreenExtractor extends ScreenFluid {

    public Player player;
    public TileEntityExtractor tile;

    public ScreenExtractor(ContainerInventory inv, TileEntity tile) {
        super(new MenuExtractor(inv, (TileEntityFluidItemContainer) tile));
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/extractor_prototype.png");
        switch (tile.tier) {
            case PROTOTYPE:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/extractor_prototype.png");
                break;
            case BASIC:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/extractor_basic.png");
                break;
            case REINFORCED:
            case AWAKENED:
                break;
        ...
        if (this.tile.isBurning()) {
            ...
            this.drawTexturedModalRect(x + 57, y + 36 + 12 - counter, 176, 12 - counter, 14, counter + 2);
        }
