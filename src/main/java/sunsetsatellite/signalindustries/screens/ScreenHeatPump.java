...
import sunsetsatellite.signalindustries.menus.MenuHeatPump;
...
public class ScreenHeatPump extends ScreenFluid {

    public Player player;
    public TileEntityHeatPump tile;

    public ScreenHeatPump(ContainerInventory inv, TileEntity tile) {
        super(new MenuHeatPump(inv, (TileEntityFluidItemContainer) tile));
        this.tile = (TileEntityHeatPump) tile;
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        if (this.tile.isBurning()) {
            ...
            this.drawTexturedModalRect(x + 80, y + 36 + 12 - counter, 176, 12 - counter, 14, counter + 2);
        }
