...
public class ScreenItemBus extends ScreenFluid {
    ...
    public ScreenItemBus(ContainerInventory inv, TileEntity tile) {
        super(new MenuItemBus(inv, (TileEntityTieredContainer) tile));
        this.ySize = 192;
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/basic_item_hatch.png");
        switch (tile.tier){
            case BASIC:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/basic_item_hatch.png");
                break;
            case REINFORCED:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/reinforced_item_hatch.png");
                break;
            case AWAKENED:
                break;
        }
