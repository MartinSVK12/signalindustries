...
public class ScreenDimAnchor extends ScreenFluid {

    public Player player;
    public TileEntityDimensionalAnchor tile;

    public ScreenDimAnchor(ContainerInventory inv, TileEntity tile) {
        super(new MenuDimAnchor(inv, (TileEntityFluidItemContainer) tile));
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/dimensional_anchor.png");
        ...
        if (this.tile.isBurning()) {
            ...
            this.drawTexturedModalRect(x + 26, y + 20 + 12 - counter, 176, 44 - counter, 14, counter + 2);
        }
        counter = this.tile.getProgressScaled(66);
        this.drawTexturedModalRect(x + 55, y + 81 - counter, 176, 112 - counter, 67, counter);
