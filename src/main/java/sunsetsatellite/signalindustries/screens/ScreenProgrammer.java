...
public class ScreenProgrammer extends ScreenFluid {
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/programmer_basic.png");
        switch (tile.tier){
            case BASIC:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/programmer_basic.png");
                break;
        }
        ...
        counter = Math.min(this.tile.getProgressScaled(54),54);
        this.drawTexturedModalRect(x + 61, y + 31, 176, 14, counter + 1, 18);
