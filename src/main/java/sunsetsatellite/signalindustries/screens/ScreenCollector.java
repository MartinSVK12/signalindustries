...
public class ScreenCollector extends ScreenFluid {
    ...
    public ScreenCollector(ContainerInventory inv, TileEntity tile) {
        super(new MenuCollector(inv, (TileEntityFluidItemContainer) tile));
        this.ySize = 192;
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        switch (tile.tier) {
            ...
            case BASIC:
                ...
                break;
            case REINFORCED:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/reinforced_energy_collector.png");
                break;
            case AWAKENED:
                break;
        }
