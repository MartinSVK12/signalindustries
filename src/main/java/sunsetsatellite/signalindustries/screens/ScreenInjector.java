...
public class ScreenInjector extends ScreenFluid {

    public Player player;
    public TileEntityEnergyInjector tile;

    public ScreenInjector(ContainerInventory inv, TileEntity tile) {
        super(new MenuInjector(inv, (TileEntityFluidItemContainer) tile));
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        if(tile.isBurning()){
            this.drawTexturedModalRect(x + 80, y + 36, 176, 0, 14, 12 + 2);
        }
