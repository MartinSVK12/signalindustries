...
public class ScreenAutoMiner extends ScreenFluid {
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        if(this.tile.isBurning()) {
            counter = 12;
            this.drawTexturedModalRect(x + 9, y + 36 + 12 - counter, 176, 0, 14, counter + 2);
        }
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        font.drawStringWithShadow("C: "+(tile.cost),80,32,0xFF800000);
    }
    ...
    public void init() {
        ...
        itemIoButton = itemIo;
        buttons.add(new ButtonElement(2, Math.round((float) width / 2) - 81, Math.round((float) height / 2) - 80, 20, 20, tile.workTimer.isPaused() ? "OFF" : "ON"));
        super.init();
    }
