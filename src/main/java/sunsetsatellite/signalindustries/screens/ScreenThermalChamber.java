...
import sunsetsatellite.signalindustries.menus.MenuThermalChamber;
...
public class ScreenThermalChamber extends ScreenMachineSimple {

    public Player player;
    public TileEntityThermalChamber tile;

    public ScreenThermalChamber(ContainerInventory inv, TileEntity tile) {
        super(new MenuThermalChamber(inv, (TileEntityFluidItemContainer) tile));
        this.tile = (TileEntityThermalChamber) tile;
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/thermal_chamber_basic.png");
        switch (tile.tier) {
            case BASIC:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/thermal_chamber_basic.png");
                break;
            case REINFORCED:
                bg = this.mc.textureManager.loadTexture("/assets/signalindustries/gui/thermal_chamber_reinforced.png");
                break;
        }
        ...
        this.drawTexturedModalRect(x + 79, y + 35, 176, 14, counter + 1, 18);
