...
public class ScreenBooster extends ScreenFluid {

    public Player player;
    public TileEntityBooster tile;

    public ScreenBooster(ContainerInventory inv, TileEntity tile) {
        super(new MenuBooster(inv, (TileEntityFluidItemContainer) tile));
