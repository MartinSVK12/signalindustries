...
public class ScreenVisualItemIOConfig extends Screen {
    ...
    public ScreenVisualItemIOConfig(Player player, MenuAbstract menu, Screen parent, TileEntityFluidItemContainer tile) {
        super(parent);
    ...
    public void renderBlock(int mx, int my) {
        ...
        BlockModelIOPreview.ioType = IOPreview.ITEM;
