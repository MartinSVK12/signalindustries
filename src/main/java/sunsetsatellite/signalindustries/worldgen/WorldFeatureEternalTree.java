...
public class WorldFeatureEternalTree extends WorldFeature {
    ...
    public WorldFeatureEternalTree(int leavesID, int logID) {
        this.leavesID = leavesID;
        this.logID = logID;
        this.heightMod = 0;
    }

    public WorldFeatureEternalTree(int leavesID, int logID, int heightMod) {
        this.leavesID = leavesID;
        this.logID = logID;
                ...
                while(true) {
                    ...
                    if (d > (double)f) {
                        ...
                        if (i2 != 0 && i2 != this.leavesID) {
                            ...
                            this.worldObj.setBlockAndMetadataWithNotify(ai1[0], ai1[1], ai1[2], l, 1);
                            ++l1;
                        }
                    }
                }
