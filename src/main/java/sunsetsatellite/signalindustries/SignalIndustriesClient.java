...
public class SignalIndustriesClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		Catalyst.GUIS.register(key("gui/reactor"), new TileGuiEntry<>(TileEntitySignalumReactor.class, null, ScreenSignalumReactor::new));
		...
		Catalyst.GUIS.register(key("gui/laser_drill"), new TileGuiEntry<>(TileEntityLaserDrill.class, MenuMachine.class, ScreenMultiblock::new));
