...
public class ItemSignalumPowerSuit extends ItemArmorTiered implements IHasOverlay, IInjectable {
	public ItemSignalumPowerSuit(@NotNull String name, @NotNull String namespaceId, int id, @NotNull ArmorMaterial material, @NonNull HumanArmorShape armorShape, @NotNull Tier tier) {
		super(name, namespaceId, id, material, armorShape, tier);
	}
