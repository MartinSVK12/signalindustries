...
public class GuiEnergyInjector extends GuiFluid {
    ...
    public String name = "Energy Injector";
    ...
    protected void drawGuiContainerBackgroundLayer(float f1) {
        int i2 = this.mc.renderEngine.getTexture("/assets/signalindustries/gui/energy_injector_basic.png");
        switch (((BlockContainerTiered)tile.getBlockType()).tier){
            case PROTOTYPE:
            case BASIC:
                i2 = this.mc.renderEngine.getTexture("/assets/signalindustries/gui/energy_injector_basic.png");
                break;
            case REINFORCED:
            case AWAKENED:
                break;
