...
public class CollectorPage
    ...
    public CollectorPage(GuidebookSection section, ArrayList<RecipeEntryMachineFluid> recipes) {
        super(section);
    ...
    protected void renderForeground(RenderEngine re, FontRenderer fr, int x, int y, int mouseX, int mouseY, float partialTicks) {
        drawStringCenteredNoShadow(fr, "Collector", x+width - 158 / 2, y+5, 0xFF808080);
        if(recipes.isEmpty()){
