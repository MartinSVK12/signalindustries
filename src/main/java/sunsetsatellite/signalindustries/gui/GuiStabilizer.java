...
public class GuiStabilizer extends GuiFluid {
    ...
    public String name = "Dilithium Stabilizer";
    public EntityPlayer entityplayer;
    public TileEntityStabilizer tile;


    public GuiStabilizer(InventoryPlayer inventoryPlayer, TileEntity tile) {
        super(new ContainerStabilizer(inventoryPlayer, (TileEntityFluidItemContainer) tile),inventoryPlayer);
    ...
    protected void drawGuiContainerForegroundLayer()
    {
        ...
        if(tile.connectedTo != null){
            fontRenderer.drawCenteredString("Connected!",90,70,0xFF00FF00);
        } else {
            fontRenderer.drawCenteredString("Nothing to stabilize.",90,70,0xFFFF0000);
        }
    }
