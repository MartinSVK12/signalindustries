...
import sunsetsatellite.signalindustries.gui.menus.MenuSensorPipe;
...
public class ScreenSensorPipeConfig extends ScreenContainerAbstract {
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        @NotNull Texture l = mc.textureManager.loadTexture("/assets/signalindustries/textures/gui/container/old/sensor_pipe_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer() {
        drawStringNoShadow(fontRenderer, "Configure: Sensor", 45, 6, 0x404040);
		drawStringNoShadow(fontRenderer, "Inventory", 8, (ySize - 96) + 2, 0x404040);
		drawStringNoShadow(fontRenderer, String.valueOf(tile.sensorAmount), 120, 42, 0x404040);
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if (mouseX >= pseudoSlotX - 1 && mouseX < pseudoSlotX + 16 + 1 && mouseY >= pseudoSlotY - 1 && mouseY < pseudoSlotY + 16 + 1) {
            ...
            if (EnvironmentHelper.isMultiplayerClient()) {
                NetworkHandler.sendToServer(new NetworkMessageSensorPipeSetFilter(new Vec3i(tile.tilePos), tile.sensorStack, tile.getClass()));
            }
        }
    }
    ...
    public void init() {
		...
		switch (tile.sensorMode) {
		    case 0 -> guibutton.displayString = "=";
			case 1 -> guibutton.displayString = "!=";
			case 2 -> guibutton.displayString = ">";
			case 3 -> guibutton.displayString = "<";
			case 4 -> guibutton.displayString = ">=";
			case 5 -> guibutton.displayString = "<=";
			case 6 -> {
				tile.sensorMode = 0;
