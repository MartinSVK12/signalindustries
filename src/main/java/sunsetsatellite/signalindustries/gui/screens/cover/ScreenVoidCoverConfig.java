...
public class ScreenVoidCoverConfig extends Screen {
    ...
    protected void drawGuiContainerForegroundLayer() {
        drawStringNoShadow(fontRenderer,"Configure: Voiding", 45, 6, 0xFF404040);
        drawStringNoShadow(fontRenderer,"Item Slot", xSize / 2 - 50, 23, 0xFF404040);
        drawStringNoShadow(fontRenderer,"Fluid Slot", xSize / 2 + 10, 23, 0xFF404040);
        drawStringNoShadow(fontRenderer,"Activate", xSize / 2 - 20, 60, 0xFF404040);
    }
    ...
    private void action2Performed(ButtonElement guibutton) {
        if (tile != null) {
            ...
            if (EnvironmentHelper.isMultiplayerClient()) {
                NetworkHandler.sendToServer(new PacketScreenAction(guibutton.id, 1, TileEntityCoverable.CHANNEL_COVERS_START + cover.getDir().getSideNumber(), new Vec3i(tile.tilePos), tile.getClass()));
            }
        }
    }
}
