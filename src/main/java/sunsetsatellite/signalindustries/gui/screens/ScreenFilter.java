...
import sunsetsatellite.signalindustries.gui.menus.MenuFilter;
...
public class ScreenFilter extends ScreenFluid {
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/textures/gui/container/old/filter.png");
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        int color = 0x404040;
        String s = Catalyst.translateNameKey(tile.getNameTranslationKey());
        int stringWidth = fontRenderer.stringWidth(s);
        drawStringNoShadow(fontRenderer, s, 90 - stringWidth / 2, 6, color);
    }
