...
import sunsetsatellite.signalindustries.gui.menus.MenuSITrommel;
import sunsetsatellite.signalindustries.tiles.machines.simple.TileEntitySITrommel;
import sunsetsatellite.signalindustries.util.IO;

import static sunsetsatellite.signalindustries.SignalIndustries.scene;

public class ScreenSITrommel extends ScreenFluid {

	public Player player;
	public TileEntitySITrommel tile;

	public ScreenSITrommel(ContainerInventory inv, TileEntity tile) {
		super(new MenuSITrommel(inv, (TileEntityFluidItemContainer) tile));
		this.tile = (TileEntitySITrommel) tile;
		this.ySize = 192;
	...
	protected void drawGuiContainerBackgroundLayer(float f) {
		...
		Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/textures/gui/container/old/basic_trommel_gui.png");
		switch (tile.tier) {
			case BASIC:
				bg = this.mc.textureManager.loadTexture("/assets/signalindustries/textures/gui/container/old/basic_trommel_gui.png");
				break;
			case REINFORCED:
				bg = this.mc.textureManager.loadTexture("/assets/signalindustries/textures/gui/container/old/centrifuge_reinforced.png");
				break;
		}
