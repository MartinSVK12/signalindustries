...
import sunsetsatellite.signalindustries.gui.menus.MenuPulsarAttachment;
...
public class ScreenPulsarAttachment extends ScreenFluid {
    ...
    public ScreenPulsarAttachment(ContainerInventory inventoryPlayer, int pulsarSlotIndex, boolean isArmor) {
        super(new MenuPulsarAttachment(inventoryPlayer, pulsarSlotIndex, isArmor));
    ...
    protected void drawGuiContainerBackgroundLayer(float f) {
        ...
        Texture bg = this.mc.textureManager.loadTexture("/assets/signalindustries/textures/gui/container/old/pulsar_ui_2.png");
