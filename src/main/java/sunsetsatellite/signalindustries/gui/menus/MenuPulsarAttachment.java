...
public class MenuPulsarAttachment extends MenuFluid {
    ...
    public MenuPulsarAttachment(ContainerInventory playerInv, int pulsarSlotIndex, boolean isArmor) {
        super(new InventoryPulsar(isArmor ? ((IPlayerPowerSuit<?>) playerInv.player).getPowerSuit().getAttachmentClass(ItemPulsarAttachment.class) : playerInv.getItem(pulsarSlotIndex)));
    ...
    @Override
    public IntList getTargetSlots(@NonNull InventoryAction inventoryAction, Slot slot, int i, Player entityPlayer) {
