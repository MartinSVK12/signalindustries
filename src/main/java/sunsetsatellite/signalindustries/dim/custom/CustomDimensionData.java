...
public class CustomDimensionData {
    ...
    public class Properties {
        ...
        public void readWorldTypeFX(CompoundTag tag) {
            ...
            if(fogColor != null) worldTypeFX.fogColor = new Vector3f((float) fogColor.x, (float) fogColor.y, (float) fogColor.z);
        ...
        public void writeWorldType(CompoundTag tag){
            ...
            saveProperty("OceanBlock", new DimPropertyBlock(Blocks.getBlock(wt.getOceanBlockIds()[0])), tag);
        ...
        private WorldType.Properties readWorldType(CompoundTag tag) {
            ...
            if(oceanBlock != null) worldTypeProps.oceanBlocks(oceanBlock);
