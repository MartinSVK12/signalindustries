...
public class WorldTypeEternity extends WorldType {
    ...
    @Override
    public int getMinY(@NonNull WorldSource world) {
        return 0;
    }

    @Override
    public int getMaxY(@NonNull WorldSource world) {
        return 255;
    }
    ...
    public @NonNull BiomeProvider createBiomeProvider(World world) {
        return new BiomeProviderSingleBiome(world, SIBiomes.biomeEternity, 1.0, 1.0, 1.0);
    }

	@Override
	public @NotNull Biome @NotNull [] allBiomes() {
		return new Biome[]{SIBiomes.biomeEternity};
	}
