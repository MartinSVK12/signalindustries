...
public class TileEntityStabilizer extends TileEntityTieredContainer implements IMultiblockPart, IHasIOPreview, IActiveForm {
                ...
                if (progressTicks > 0) {
                    ...
                    if (connectedTo instanceof IStabilizable && ((IStabilizable) connectedTo).isActive()) {
                        ...
                        if (connectedTo instanceof TileEntityDimensionalAnchor) {
                            ...
                            Vec3i connectedPos = new Vec3i(connectedTo.tilePos);
    ...
    public boolean canProcess() {
        return ((itemContents[0] != null && itemContents[0].getItem().equals(SIItems.dilithiumShard)) || progressTicks > 0) && ((fluidContents[0] != null && fluidContents[0].amount >= cost) || isBurning()) && connectedTo instanceof IStabilizable;
