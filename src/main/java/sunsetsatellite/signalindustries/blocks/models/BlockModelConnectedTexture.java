...
public class BlockModelConnectedTexture extends BlockModelTransparent<BlockLogic> {
    ...
    public BlockModelConnectedTexture(Block<? extends BlockLogic> block, String key, List<Block<?>> connectsTo) {
        super((Block<BlockLogic>) block, false);
        ...
        setAllTextures(0, TextureRegistry.getTexture(key + "_0"));
    }
