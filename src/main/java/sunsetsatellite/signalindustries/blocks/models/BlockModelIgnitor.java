...
public class BlockModelIgnitor extends BlockModelStandard<BlockLogicMachine> {
    ...
    public BlockModelIgnitor(Block<?> block) {
        super((Block<BlockLogicMachine>) block);
        ...
        setTex(0, defaultTextures.get(Side.TOP), Side.TOP);
        setTex(0, defaultTextures.get(Side.BOTTOM), Side.BOTTOM);
        setTex(0, defaultTextures.get(Side.NORTH), Side.NORTH);
        setTex(0, defaultTextures.get(Side.SOUTH), Side.SOUTH);
        setTex(0, defaultTextures.get(Side.EAST), Side.EAST);
        setTex(0, defaultTextures.get(Side.WEST), Side.WEST);
    }
