...
public class NANDProgrammerStateInterpreter extends MetaStateInterpreter {
    @Override
    public HashMap<String, String> getStateMap(WorldSource worldSource, int x, int y, int z, Block<?> block, int meta) {
        HashMap<String, String> result = new HashMap<>();
        TileEntityProgrammer tile = (TileEntityProgrammer) worldSource.getTileEntity(x, y, z);
        if (tile != null) {
            ...
            if (tile.itemContents[1] != null && tile.itemContents[1].getItem() == SIItems.abilityContainerCasing) {
