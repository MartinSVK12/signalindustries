            ...
            for (RecipeOutputStack outputStack : getOutput()) {
                if (outputStack.isItem()) {
                    ...
                    if (stack != null && outputStack.randomAmount) {
						stack.stackSize = multiblock.random.nextInt(outputStack.amountMin, outputStack.amountMax + 1);
                    }
                    if (stack != null) {
                    ...
                    if (fluidStack != null && outputStack.randomAmount) {
						fluidStack.amount = multiblock.random.nextInt(outputStack.amountMin, outputStack.amountMax + 1);
                    }
                    if (fluidStack != null) {
                        if (multiblock.random.nextFloat() <= outputStack.chance) {
                            int multiplier = 1;
        ...
        if (machine.random.nextFloat() <= getData().chance) {
            for (RecipeOutputStack outputStack : getOutput()) {
                if (outputStack.isItem()) {
                    ItemStack stack = getOutput() == null ? null : outputStack.stack.copy();
                    if (stack != null && outputStack.randomAmount) {
						stack.stackSize = machine.random.nextInt(outputStack.amountMin, outputStack.amountMax + 1);
                    }
                    if (stack != null) {
                    ...
                    FluidStack fluidStack = getOutput() == null ? null : outputStack.fluid.copy();
                    if (fluidStack != null && outputStack.randomAmount) {
						fluidStack.amount = machine.random.nextInt(outputStack.amountMin, outputStack.amountMax + 1);
                    }
                    if (fluidStack != null) {
                        if (machine.random.nextFloat() <= outputStack.chance) {
                            int multiplier = 1;
